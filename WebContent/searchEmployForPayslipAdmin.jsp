...
<title>Maas Durumu Kontrolü</title>
<style type="text/css">
<!--
.style1 {
	font-size: 36px;
...
<br><h2 align="center" class="style1"> Maas Durumu Kontrolü </h2><br>
<p align="center"><strong>Çalisan TC Kimlik No: <input type= "text" name = "emp">
</strong><br>
<br><p align="center">
  <input type= "hidden" name = "page" value = "Payslip" />
  <input class="btn" type="submit" name="Submit" value="Ara" align="middle"/>
</form>
</body>
</html>
