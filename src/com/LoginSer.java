...
public class LoginSer extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{	
			...
			rd=request.getRequestDispatcher("updateEmploy.jsp");
			rd.forward(request, response);
		}
	...
	if(pagename.equals("SDelete"))
	{
			...
			rd=request.getRequestDispatcher("deleteEmploy.jsp");
			rd.forward(request, response);
	}
	...
	{   
		...
		rd=request.getRequestDispatcher("updateProject.jsp");
		rd.forward(request, response);
	}
	...
	{	
		...
		rd=request.getRequestDispatcher("createPayslip.jsp");
		rd.forward(request, response);
	}
	...
	{	
		...
		rd=request.getRequestDispatcher("ResultPayslip.jsp");
		rd.forward(request, response);
	}
